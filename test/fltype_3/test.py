...
############################################################################
#
# $HeadURL: https://www.mech.kth.se/svn/simson/trunk/test/fltype_3/test.py $
...
for case in caselist:
    ...
    print '  Compiling...'
    shutil.copyfile('../../../examples/temporal-blasius/par.f','../../../par.f')
    shutil.copyfile('../../../examples/temporal-blasius/par.f','./par.f')
    ...
    if case == "test1":
        ...
        shutil.copyfile('../../../examples/temporal-blasius/bls.localized.i','bls.i')
        shutil.copyfile('../../../examples/temporal-blasius/bla.i','./bla.i')
        shutil.copyfile('../../../examples/temporal-blasius/fsc.i','./fsc.i')
