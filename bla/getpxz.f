c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/trunk/bla/getpxz.f $
c $LastChangedDate: 2007-11-23 11:44:52 +0100 (Fri, 23 Nov 2007) $
c $LastChangedBy: pschlatt@MECH.KTH.SE $
c $LastChangedRevision: 954 $
c
c ***********************************************************************
#ifndef ALLTOALL
...
c         write(*,*) '##################'
c         write(*,*) 'in getpxz 1. Here at the end', yb, my_node, i
c         write(*,*) '##################'
c      endif
...
c      if(my_node.eq.0) then
c         write(*,*) '##################'
c         write(*,*) 'in getpxz 2. Here at the end', yb, my_node, i
c         write(*,*) '##################'
c      endif
