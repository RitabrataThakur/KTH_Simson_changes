c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/trunk/bla/linearbl.f $
c $LastChangedDate: 2011-10-22 15:02:36 +0200 (Sat, 22 Oct 2011) $
c $LastChangedBy: pschlatt@MECH.KTH.SE $
c $LastChangedRevision: 1748 $
c
c ***********************************************************************
...
c     Wall roughness
c
         if ((wbci .eq. -1) .and. (my_node .eq. 0)) then
...
c     Solve for u0
c
               call setmacrhs(uw,fuw,c0,d0,e0,lam2,1,ny,1,1,ny)
