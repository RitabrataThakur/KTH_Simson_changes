...
#########################################################################
#
# $HeadURL: https://www.mech.kth.se/svn/simson/trunk/paraview/paraviewscripts/setup_movie.py $
# $LastChangedDate: 2011-07-08 23:39:43 +0200 (Fri, 08 Jul 2011) $
# $LastChangedBy: pschlatt@MECH.KTH.SE $
# $LastChangedRevision: 1739 $
#
#########################################################################
import vtk
import subprocess
