%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%$HeadURL: https://www.mech.kth.se/svn/simson/trunk/doc/simson-paraview-guide.tex $
%$LastChangedDate: 2011-05-31 15:44:55 +0200 (Tue, 31 May 2011) $
...
\usepackage[colorlinks=true, pdfstartview=FitV, linkcolor=blue, citecolor=blue, urlcolor=blue, pdfkeywords={DNS, Simson, subversion, svn}, pdfauthor={}, pdftitle={User Guide. Produced from $Rev: 1675 $}]{hyperref}
...
\kthinnerbacktwo{This user guide is compiled from $Rev: 1675 $.}
