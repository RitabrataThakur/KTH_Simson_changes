c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/trunk/bla/wampbl.f $
c $LastChangedDate: 2013-03-08 18:21:48 +0100 (Fri, 08 Mar 2013) $
c $LastChangedBy: taras@MECH.KTH.SE $
c $LastChangedRevision: 1819 $
c
c ***********************************************************************
...
c      write(15,*) sum(8),e0,hplus
      write(15,'(20(e25.16e3,tr1))') t/dstar,(sum(j),j=1,3),
