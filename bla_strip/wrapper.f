C************************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/trunk/bla/wrapper.f $
c $LastChangedDate: 2011-11-17 15:02:16 +0100 (Thu, 17 Nov 2011) $
c $LastChangedBy: taras@MECH.KTH.SE $
c $LastChangedRevision: 1757 $
c
c ***********************************************************************
      program wrapper
...
c
     ...
     &              '                      *'
         write(ios,*) '*                             Simson        '//
     &              '                      *'
         write(ios,*) '*               wrapper for bla $Rev: 1757 $'//
     &              '                      *'
         write(ios,*) '*                                           '//
     &              '                      *'
         write(ios,*) '********************************************'//
