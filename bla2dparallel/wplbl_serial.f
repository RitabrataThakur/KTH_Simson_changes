c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/branches/bla2dparallel/wplbl_serial.f $
...
c
      ...
      write(*,*) '** write planes (serial) **',t/dstar
