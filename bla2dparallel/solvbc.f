c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/branches/bla2dparallel/solvbc.f $
c $LastChangedDate: 2007-10-29 14:23:13 +0100 (Mon, 29 Oct 2007) $
c $LastChangedBy: qiang@MECH.KTH.SE $
c $LastChangedRevision: 786 $
c
c ***********************************************************************
      subroutine solvbc(bcm,bcdr,bcdi,zb,my_node_world)
c
...
c
      ...
      integer zb
      real bcm(memnx*mbz,3,3),bcdr(memnx*mbz,3),bcdi(memnx*mbz,3)
      
      integer n1,nxz,j,xz,my_node_world
      real tmp,tm
