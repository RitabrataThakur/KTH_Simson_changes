c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/branches/bla2dparallel/boxcfl.f $
c $LastChangedDate: 2009-04-02 16:00:32 +0200 (Thu, 02 Apr 2009) $
c $LastChangedBy: pschlatt@MECH.KTH.SE $
c $LastChangedRevision: 1399 $
c
c ***********************************************************************
...
c
         ...
         if (scalar.ne.0 .and. wbci.eq.0) then
            if (ny.ge.17) dyinv=min(dyinv,real(ny-1)**2/10./3.14*6)
         end if
c
