c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/branches/bla2dparallel/rstreakbl.f $
...
c
      if (ndxst.gt.180) then
         write(*,*) 'not enough streamwise positions in rstreakbl'
     ...
     &           wwst_r(n,i,1),wwst_i(n,i,1) 
      ...
      if (ndxst.ne.ndxst1) then
         write(*,*) 'number of streak positions differ'
