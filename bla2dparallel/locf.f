c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/branches/bla2dparallel/locf.f $
c $LastChangedDate: 2011-01-27 17:00:52 +0100 (Thu, 27 Jan 2011) $
c $LastChangedBy: pschlatt@MECH.KTH.SE $
c $LastChangedRevision: 1641 $
c
c ***********************************************************************
...
c
      ...
      real pi     
      real amp2d,amp3d,tomeg3d,ft3d,zb,zp
...
c     Volume force, note that it is nonzero on the wall
c
                  om2r(x,y,zp,1)=om2r(x,y,zp,1)+ampx*fy*ft*fx1(x)
                  om2i(x,y,zp,1)=om2i(x,y,zp,1)+ampx*fy*ft*fx2(x)
                  om2r(x,y,zp,2)=om2r(x,y,zp,2)+ampy*fy*ft*fx1(x)
                  om2i(x,y,zp,2)=om2i(x,y,zp,2)+ampy*fy*ft*fx2(x)
                  om2r(x,y,zp,3)=om2r(x,y,zp,3)+ampz*fy*ft*fx1(x)
                  om2i(x,y,zp,3)=om2i(x,y,zp,3)+ampz*fy*ft*fx2(x)
               end do
            end do
         end do
      end if
