c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/branches/bla2dparallel/cvecfft_acc.f $
c $LastChangedDate: 2009-10-27 10:17:54 +0100 (Tue, 27 Oct 2009) $
c $LastChangedBy: pschlatt@MECH.KTH.SE $
c $LastChangedRevision: 1432 $
c
c ***********************************************************************
...
cvd$g nolstval
      ...
      real war(*),was(*)
      integer ifac(*)
      real xr(inc,*),xi(inc,*),wr(inc,*),wi(inc,*)
      real sqrt3
      parameter(sqrt3=1.7320508075688772935)
...
106   continue
      ...
      real  ccr(ido/2,l1,3),cci(ido/2,l1,3), wa1(*),wa2(*)
      real taur,taui
