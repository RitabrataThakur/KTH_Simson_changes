c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/branches/bla2dparallel/ffun.f $
c $LastChangedDate: 2009-10-27 10:18:24 +0100 (Tue, 27 Oct 2009) $
c $LastChangedBy: pschlatt@MECH.KTH.SE $
c $LastChangedRevision: 1433 $
c
c ***********************************************************************
      subroutine ffun(fstart,fend,frise,ffall,fmax,
     &     xl,zl,tc,xsc,zsc,
     &     xc1,xc2,fring1,fring2,cphas1,cphas2,sphas1,sphas2,
     &     osnumb,osomega,osalr,osali,osbeta,osamp,osdamp,osmod,
     &     my_node_world)
c
...
c                        end if
                        ...
                        cphas1(j,x,zp)=cos(phas1)*damp1
                        sphas1(j,x,zp)=sin(phas1)*damp1
                        cphas2(j,x,zp)=cos(phas2)*damp2
                        sphas2(j,x,zp)=sin(phas2)*damp2
                     end do
                  end do
               end do
!$OMP END PARALLEL DO
