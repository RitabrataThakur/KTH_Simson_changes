c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/branches/bla2dparallel/lenbox.f $
...
c ***********************************************************************
     ...
     &     dstar,bstart,bslope,tabfre,namfre,u0low,w0low,
...
c
      ...
      real bstart,bslope,fstart,fend,dstar,rlam,spanv,re
...
c
     ...
     &        bstart,bslope,tabfre,namfre,u0low,w0low,prextm,prey,
