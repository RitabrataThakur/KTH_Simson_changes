c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/branches/bla2dparallel/vecfft_orig.f $
...
c
  ...
  101  continue
      ...
      if (ifail.eq.0.and.ifailn.ne.0) then
          if (ifailn.eq.1) then
            write(*,*) 'VCOSSI-ERROR-N MUST BE EVEN'
          else
            write(*,*) 'VCOSSI-ERROR-CANNOT FACTOR',ifailn
          end if
        stop
      end if
      if (ifail.ne.0) ifail=ifailn    
