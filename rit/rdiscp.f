c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/trunk/rit/rdiscp.f $
c $LastChangedDate: 2009-10-25 20:29:24 +0100 (Sun, 25 Oct 2009) $
c $LastChangedBy: pschlatt@MECH.KTH.SE $
c $LastChangedRevision: 1427 $
c
c ***********************************************************************
...
c      read(12,err=1009)re,pou,xl,zl,t,xs,
c     &        (pr(i),gr(i),m1(i),i=1,scalar),ivarvisc
