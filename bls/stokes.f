c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/trunk/bls/stokes.f $
c $LastChangedDate: 2007-11-08 19:23:26 +0100 (Thu, 08 Nov 2007) $
c $LastChangedBy: pschlatt@MECH.KTH.SE $
c $LastChangedRevision: 806 $
c
c ***********************************************************************
...
c
       ...
       if (k2.eq.0.and.is.le.1) then
!          write(*,*)'In stokes.f', is, k2
          return
       end if
       k=sqrt(k2)
c
