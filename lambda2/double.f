c ***********************************************************************
c
c $HeadURL: https://www.mech.kth.se/svn/simson/trunk/lambda2/double.f $
c $LastChangedDate: 2010-10-04 21:48:11 +0200 (Mon, 04 Oct 2010) $
c $LastChangedBy: mattias@MECH.KTH.SE $
c $LastChangedRevision: 1555 $
c
c ***********************************************************************
      program double
